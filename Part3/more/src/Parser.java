...
class Parser {
    ...
    private boolean var;
    private boolean num;
    private boolean ifInstr;
    private boolean whileInstr;
    private boolean forInstr;
    private boolean printInstr;
    private boolean readInstr;
    private boolean end;
    private boolean endif;
    private boolean elseInstr;
    private boolean doneInstr;
    private boolean by;
    private boolean to;
    ...
    private boolean andInstr;
    private boolean orInstr;
    private boolean then;
    private boolean doInstr;
    private boolean timesOp;
    private boolean divOp;
    private boolean semicolon;
    private boolean rparen;

    private GenericStack<Symbol> tokensList;
    private LexicalUnit tokenType;
